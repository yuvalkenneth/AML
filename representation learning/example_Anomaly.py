...
#     torch.flip(anomalies_vicreg, [0])
#     torch.flip(anomalies_no_generated, [0])
#     fig, axs = plt.subplots(2, 7)
#     fig.suptitle('Anomalies')
#     axs[0].set_title('Original VICReg')
#     axs[1].set_title('No Generated Neighbors')
#     for i in range(7):
#         image = cifar10_testset[anomalies_vicreg[i]][0] if anomalies_vicreg[i] < 10000 else mnist_testset[
#             anomalies_vicreg[i] - 10000][0]
#         axs[0, i].imshow(image.permute(1, 2, 0))
#         axs[0, i].set_title('Anomaly {}'.format(i + 1))
#         axs[0, i].axis('off')
#         image_no_generated = cifar10_testset[anomalies_no_generated[i]][0] if anomalies_no_generated[i] < \
#                                                                               10000 else \
#             mnist_testset[anomalies_no_generated[i] - 10000][0]
#         axs[1, i].imshow(image_no_generated.permute(1, 2, 0))
#         axs[1, i].set_title('Anomaly {}'.format(i + 1))
#         axs[1, i].axis('off')
